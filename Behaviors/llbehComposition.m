...
% fPath         - working path to read/write data
% StratTypeFolder-path addition according to control strategy
% FolderName    - trial assembly path
% pType         - string indicating what axis we are on
...
%**************************************************************************
function [llbehStruc,llbehLbl,htext] = llbehComposition(StrategyType,motComps,curHandle,TL,BL,...
                                                        fPath,StratTypeFolder,FolderName,...
                                                        pType,Index)

%% Debugging Flags and Global Variables
% Global variables defined in the main file for program:
% SnapVerification.m/pRCBHT.m
%------------------------------------------------------------------------------------------
    global DB_PRINT;
    global DB_WRITE;
%------------------------------------------------------------------------------------------   
...
%         CODEGEN DISABLED: C++ cannot plot
